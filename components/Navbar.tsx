      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          <div className="flex-shrink-0 flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-slate-900 dark:text-slate-900">Nivedan P S</span>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3 border-l border-slate-200 dark:border-slate-700 pl-4">
              <a
                ...
                className="px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider bg-indigo-600 hover:bg-indigo-700 text-white shadow-md hover:shadow-indigo-500/25 transition-all hover:scale-105 inline-flex items-center gap-1.5"
              >
        ...
        <div className="md:hidden bg-white/95 border-t border-slate-100">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setIsMenuOpen(false)}
              className="block px-3 py-2 rounded-md text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 text-center mt-2"
            >
              Download CV
            </a>
          </div>
