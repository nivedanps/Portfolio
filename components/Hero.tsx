  ...
  return (
    <section id={id} className="min-h-screen flex items-center justify-center pt-20 px-4 transition-colors duration-300">
      <div className="max-w-4xl mx-auto text-center space-y-6">
        ...
        <p className="text-lg text-slate-500 dark:text-slate-400 font-medium flex items-center justify-center gap-2">
        ...
        <div className="flex gap-4 justify-center items-center pt-4">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-3 rounded-full bg-slate-100 dark:bg-slate-200 text-slate-700 hover:bg-indigo-600 hover:text-white transition-all transform hover:scale-110 shadow-md"
            aria-label="GitHub"
          >
